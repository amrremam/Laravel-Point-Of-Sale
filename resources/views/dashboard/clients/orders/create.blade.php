    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">@lang('Add order')</li>
            </ol>
        </section>
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <form action="{{ route('dashboard.clients.orders.store', $client->id) }}" method="post">
                                ...
                                <h4>@lang('Total') : <span class="total-price">0</span></h4>

                                <button class="btn btn-primary btn-block disabled" id="add-order-form-btn"><i class="fa fa-plus"></i> @lang('Add order')</button>
                    ...
                    @if ($client->orders->count() > 0)
                        ...
                        <div class="box box-primary">
                            ...
                            <div class="box-header">
                                ...
                                <h3 class="box-title" style="margin-bottom: 10px">@lang('previous_orders')
